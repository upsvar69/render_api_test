"""
just change the name to "app.py" and you get it back online on render however
this app was only supposed to test if the api connections work well and they do except for reuters
"""
